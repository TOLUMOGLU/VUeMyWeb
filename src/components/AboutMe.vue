<template>
  <v-container
    ...
    style="background: linear-gradient(to right, white  33.3%, #648DB3 33.3%); min-height: 100vh;"
  >
    <v-col class="pa-12" cols="12" md="10" style="height: auto;">
      <v-row no-gutters style="height: 100%;">
        ...
        >
          ...
          <div class="text-center text-white pa-2 pa-md-6">
            <h1 class="pa-2"><strong>Azime</strong></h1>
            <h1 class="pa-2"><strong>Tolumoğlu</strong></h1>
            <h2 class="pa-2">SOFTWARE ENGINEER</h2>
          </div>
          <div
          ...
          >
            <v-btn
              icon
              variant="text"
              href="https://www.linkedin.com/in/azime-tolumo%C4%9Flu/"
              target="_blank"
              rel="noopener"
            >
            ...
            <v-btn
              icon
              variant="text"
              href="https://github.com/TOLUMOGLU"
              target="_blank"
              rel="noopener"
            >
            ...
            <v-btn
              icon
              variant="text"
              href="https://medium.com/@tolumogluazime2"
              target="_blank"
              rel="noopener"
            >
        ...
        <v-col
          cols="12"
          md="8"
          class="pa-12 text-left"
          style="height: 100%;"
        >
          <h1 class="pa-3 text-white"><strong>Hello</strong></h1>
          <h2 class="mb-4 pa-3">Here's who I am &amp; what I do</h2>
          <div
            class="d-flex justify-start mb-4 pa-3" 
            style="gap: 20px;">
